    ...
    const columns: TableProps<DataType>['columns'] = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <div className="pr-2">
                    {record.role === 'OWNER' ?
                        <Tag color="blue">{commonTranslations('owner')}</Tag>
                        :
                        <Select
                            ...
                            size="small"
                            options={[
                                { label: commonTranslations('author'), value: 'AUTHOR' },
                                { label: commonTranslations('admin'), value: 'ADMIN' },
                                { label: commonTranslations('editor'), value: 'EDITOR' },
                            ]}
                        />
                    }
                </div>
